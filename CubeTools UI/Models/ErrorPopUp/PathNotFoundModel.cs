...
{
    public class PathNotFoundModel : ErrorPopUpModel
    {
        private MainWindowModel _mainReference;
    
        public PathNotFoundModel(Views.ErrorPopUp.ErrorPopUp attachedView, ManagerException exception, MainWindowModel main) : base(attachedView, exception)
        {
            _mainReference = main;
        }
