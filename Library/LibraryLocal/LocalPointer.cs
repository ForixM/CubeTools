...
namespace Library
{
    ...
    /// <summary>
    /// ##################### Local Pointer ABSTRACT CLASS ######################## <br></br>
    ...
    /// ##################################################################
    /// </summary>
    public abstract partial class LocalPointer : Pointer
    {
        // This region contains every variables that stores the information of the file
        #region Variables
        
        public static FilePointer.FileLocalPointer NullLocalPointer = new();
        ...
        public LocalPointer(string path) : this()
        {
            path = path.Replace("\\", "/");
        ...
        public static bool operator ==(LocalPointer ft, LocalPointer ft2)
        {
        ...
        public static bool operator !=(LocalPointer ft, LocalPointer ft2) => !(ft == ft2);

        protected bool Equals(LocalPointer other) => Path == other.Path && Name == other.Name && Type == other.Type && Size == other.Size &&
        ...
        public override bool Equals(object? obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((LocalPointer) obj);
        }
