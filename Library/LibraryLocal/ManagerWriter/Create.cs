...
namespace Library.ManagerWriter
{
    public static partial class ManagerWriter
    {
        ...
        public static FilePointer.FileLocalPointer Create(string dest = "", string extension = "")
        {
        ...
        public static DirectoryPointer.DirectoryLocalPointer CreateDir(string dest = "Folder", bool generate = false)
        {
            // Source or dest have an incorrect format
            ...
            switch (generate)
            {
                ...
                case false when Directory.Exists(dest): return new DirectoryPointer.DirectoryLocalPointer(dest);
            }
