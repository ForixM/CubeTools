...
namespace Library
{
    ...
    /// </summary>
    public class DirectoryPointer : Pointer
    {
        #region Variables
        ...
        public List<FilePointer> ChildrenFiles { get; set; }
        ...
        {
            ChildrenFiles = new List<FilePointer>();
            _directoryInfo = null;
            Watcher = null;
        }
        ...
        /// <summary>
        ///     This function creates a FilePointer and return it using a path
        ...
        public FilePointer GetChild(string path)
        {
        ...
        public void SetChildrenFiles()
        {
            ...
            foreach (var dir in Directory.GetDirectories(Path))
                ChildrenFiles.Add(new FilePointer(dir.Replace('\\', '/')));
            foreach (var file in Directory.GetFiles(Path)) 
                ChildrenFiles.Add(new FilePointer(file.Replace('\\', '/')));
        }
        ...
        /// </summary>
        /// <param name="ft"></param>
        public void AddChild(FilePointer ft)
        {
            if (HasChild(ft.Path))
                return;
        ...
        /// <summary>
        /// Overload of <see cref="AddChild(FilePointer)"/>
        /// </summary>
        ...
        public void Remove(FilePointer ft)
        {
            for (var i = 0; i < ChildrenFiles.Count; i++)
