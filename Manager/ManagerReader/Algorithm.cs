...
namespace Manager.ManagerReader
{
    public static partial class ManagerReader
    {
        ...
        public static List<string> SearchIndexationByFullName(string source, string name)
        {
            ...
            while (line != null)
            {
                Tuple<int, string, string> tmp = GetInformationByLineIndexation(line);
                if (tmp.Item2 == name)
                    res.Add(tmp.Item3);
                line = sr.ReadLine();
            }
        ...
        private static string GenerateIndexation(string baseRoot)
        {
            ...
            string indexationName = $"indexation{GetPathToName(baseRoot)}.txt";
            string indexationPath = "";
            ...
            DirectoryInfo di = new DirectoryInfo(baseRoot);
            int line = 0;
