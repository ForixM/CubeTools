    ...
    public class ReaderTests
    {
        ...
        */
        ...
        public void GetFileCreationDate(string name, bool exist)
        {
            ...
            if (exist)
            {
                Assert.AreEqual(File.GetCreationTime(name).ToString(CultureInfo.CurrentCulture),
                    ManagerReader.GetFileCreationDate(name));
                return;
            }
        ...
        public void GetFileLastEdition(string name, bool exist)
        {
            ...
            if (exist)
            {
                Assert.AreEqual(File.GetLastWriteTime(name).ToString(CultureInfo.CurrentCulture),
                    ManagerReader.GetFileLastEdition(name));
                return;
            }
        ...
        public void GetFileAccessDate(string name, bool exist)
        {
            ...
            if (exist)
            {
                Assert.AreEqual(File.GetLastAccessTime(name).ToString(CultureInfo.CurrentCulture),
                    ManagerReader.GetFileAccessDate(name));
                Assert.Pass("Success");
            }
        ...
        [Test]
        [TestCase("reader.txt",
            "C:/Users/mateo/OneDrive/Documents/GitHub/CubeTools/Tests/Tests/ReaderTests/reader.txt")]
        [TestCase("reader", "C:/Users/mateo/OneDrive/Documents/GitHub/CubeTools/Tests/Tests/ReaderTests/reader")]
        [TestCase("None", "None")]
        ...
        */
        ...
        [Test]
        [TestCase(true, "C:/Users/mateo/OneDrive/Documents/GitHub/CubeTools/Tests/Tests/WriterTests")]
        [TestCase(false, "C:\\eféedù%^^$")]
        [TestCase(false,
            "************************************************aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa************************************************aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa")]
        [TestCase(false,
