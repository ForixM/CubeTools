...
namespace Ui.Views
{
    public class LinkBar : UserControl
    {
        ...
        {
            Model.ParentModel?.ModelLocal.ModelNavigationBar.Add(new DirectoryPointer(Environment.GetFolderPath(Environment.SpecialFolder.MyMusic)));
        ...
        {
            Model.ParentModel?.ModelLocal.ModelNavigationBar.Add(new DirectoryPointer(Environment.GetFolderPath(Environment.SpecialFolder.MyVideos)));
        ...
        {
            Model.ParentModel?.ModelLocal.ModelNavigationBar.Add(new DirectoryPointer(Environment.GetFolderPath(Environment.SpecialFolder.Favorites)));
        ...
        {
            Model.ParentModel?.ModelLocal.ModelNavigationBar.Add(new DirectoryPointer(Environment.GetFolderPath(Environment.SpecialFolder.MyComputer)));
        ...
        {
            Model.ParentModel?.ModelLocal.ModelNavigationBar.Add(new DirectoryPointer(Environment.GetFolderPath(Environment.SpecialFolder.UserProfile)));
